...
public class SWInputSensorClass implements SensorEventListener {
    ...
    public SWInputSensorClass(SensorManager sensorManager, Handler handlerUI){
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        Log.d("Msg", ""+event.sensor.getType());
