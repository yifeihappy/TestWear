...
public class PCISSActivity extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pc_iss_activity_main);
            ...
            public void onClick(View v) {
                if(STATE) {
                    ...
                    if(null == IP || IP.equals("")) {
                        Toast.makeText(PCISSActivity.this, "IP is illegal!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    // connect to server
                    ...
                    // ISS start
                    Message msgISS = Message.obtain();
                    msgISS.obj = "ISS";
                    socketClientThread.sockhandler.sendMessage(msgISS);
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msgcode) {
                case SOCKET_CONNECT_ERROR:
                    Toast.makeText(PCISSActivity.this, "Fail to connect to Server!", Toast.LENGTH_SHORT).show();
                    break;
                case TIMESTAMP:
                    ...
                    break;
                case SEND_FAILD:
                    Toast.makeText(PCISSActivity.this, "Send data error!", Toast.LENGTH_SHORT).show();
                    break;
            }
