package com.example.a14776.testwear.libsvm;
...
//		DataOutputStream fp = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(model_file_name)));
		...
		File fullFilename = new File(extDir, model_file_name);
		if(fullFilename.exists()) {
			fullFilename.delete();
		}
		fullFilename.createNewFile();
		DataOutputStream fp = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(fullFilename)));
